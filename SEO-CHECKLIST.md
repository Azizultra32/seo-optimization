# Armada MD / Dr. Ali Ghahary – SEO & Structure Checklist

## ✅ Metadata & Schema

- [x] layout.tsx contains comprehensive metadata with title, description, keywords
- [x] Armada Housecall™ mentioned in metadata
...
- [x] JSON-LD structured data for Product (Armada Housecall™)
- [x] JSON-LD structured data for WebSite

## ✅ Content

- [x] "Armada Housecall™" spelled consistently (note: currently without ™ symbol in page content)
